...
#else
#define STDCALL
# if defined(JL_LIBRARY_EXPORTS_INTERNAL) && (defined(_OS_LINUX_) || defined(__ELF__))
#  define JL_DLLEXPORT __attribute__ ((visibility("protected")))
# endif
# if defined(JL_LIBRARY_EXPORTS_CODEGEN) && (defined(_OS_LINUX_) || defined(__ELF__))
#  define JL_DLLEXPORT_CODEGEN __attribute__ ((visibility("protected")))
# endif
